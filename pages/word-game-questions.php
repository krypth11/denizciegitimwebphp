...
<script>
 ...
 let bulkItems=[];
  ...
  function renderBulkPreview(){
    ...
    $('#bulkPreview').html(`
      <div class="card border-0" style="background:rgba(255,255,255,.03)">
        <div class="card-body py-3">
          <div class="fw-semibold mb-2">Ayrıştırma Sonucu</div>
    ...
    `);
    $('#saveBulk').prop('disabled',state.validCount===0);
  }
