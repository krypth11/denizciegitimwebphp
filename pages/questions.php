...
<div class="modal fade" id="addModal" tabindex="-1">
    <div class="modal-dialog modal-lg"><div class="modal-content"><div class="modal-header"><h5 class="modal-title">Yeni Soru Ekle</h5><button type="button" class="btn-close" data-bs-dismiss="modal"></button></div>
        <form id="addForm" enctype="multipart/form-data"><div class="modal-body">
            ...
            <div class="mb-3"><label class="form-label">Video Çözüm Bağlantısı <small class="text-muted">(opsiyonel)</small></label><input type="url" class="form-control" name="video_solution_url" placeholder="https://www.youtube.com/watch?v=..."><small class="text-muted">YouTube, youtu.be, Shorts veya embed bağlantısı kabul edilir.</small></div>
            <div class="row">
...
<div class="modal fade" id="editModal" tabindex="-1">
    <div class="modal-dialog modal-lg"><div class="modal-content"><div class="modal-header"><h5 class="modal-title">Soru Düzenle</h5><button type="button" class="btn-close" data-bs-dismiss="modal"></button></div>
        <form id="editForm" enctype="multipart/form-data"><input type="hidden" name="id" id="edit_id"><div class="modal-body">
            ...
            <div class="mb-3"><label class="form-label">Video Çözüm Bağlantısı <small class="text-muted">(opsiyonel)</small></label><input type="url" class="form-control" name="video_solution_url" id="edit_video_solution_url" placeholder="https://www.youtube.com/watch?v=..."><small class="text-muted">Alanı boş kaydederseniz mevcut video kaldırılır.</small></div>
...
$(document).ready(function() {
    ...
    $(document).on('click', '.edit-btn', function(){
        ...
        $.getJSON('../ajax/questions.php?action=get&id='+id, function(r){
            ...
            $('#edit_video_solution_url').val(q.video_solution_id ? `https://www.youtube.com/watch?v=${q.video_solution_id}` : '');
