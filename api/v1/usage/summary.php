...
try {
    ...
    usage_limits_subscription_debug_log('usage_summary_computed', [
        ...
        'premium_plan_code' => $summary['premium_plan_code'] ?? null,
        'premium_plan_label' => $summary['premium_plan_label'] ?? null,
        'premium_provider' => $summary['premium_provider'] ?? null,
        'premium_source' => $summary['premium_source'] ?? null,
        'premium_source_label' => $summary['premium_source_label'] ?? null,
        'premium_started_at' => $summary['premium_started_at'] ?? null,
        'premium_expires_at' => $summary['premium_expires_at'] ?? null,
        'effective_expires_at' => $summary['effective_expires_at'] ?? null,
        'subscription_started_at' => $summary['subscription_started_at'] ?? null,
        'subscription_expires_at' => $summary['subscription_expires_at'] ?? null,
        'premium_bonus_started_at' => $summary['premium_bonus_started_at'] ?? null,
        'premium_bonus_until' => $summary['premium_bonus_until'] ?? null,
        'premium_bonus_active' => $summary['premium_bonus_active'] ?? null,
        'premium_bonus_source' => $summary['premium_bonus_source'] ?? null,
        'premium_bonus_days' => $summary['premium_bonus_days'] ?? null,
    ...
    if (usage_limits_subscription_debug_enabled()) {
        $summary['debug'] = [
            ...
            'premium_details' => [
                ...
                'subscription_started_at' => $summary['subscription_started_at'] ?? null,
                'subscription_expires_at' => $summary['subscription_expires_at'] ?? null,
                'subscription_is_active' => $summary['subscription_is_active'] ?? null,
                'premium_bonus_started_at' => $summary['premium_bonus_started_at'] ?? null,
                'premium_bonus_until' => $summary['premium_bonus_until'] ?? null,
                'premium_bonus_active' => $summary['premium_bonus_active'] ?? null,
                'premium_bonus_source' => $summary['premium_bonus_source'] ?? null,
