...
try {
    ...
    $currentQualificationId = api_require_current_user_qualification_id($pdo, $auth, 'mock-exams.abandon');
    ...
    api_assert_requested_qualification_matches_current(
        ...
        'mock-exams.abandon.attempt'
    );

    $result = mock_exam_abandon($pdo, $userId, $attemptId, $elapsedSeconds);
    api_success('Deneme sonlandırıldı.', $result);
} catch (Throwable $e) {
